...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      ...
      <nav style={{ top: "max(1.5rem, env(safe-area-inset-top, 1.5rem))" }} className="md:hidden fixed inset-x-4 z-50 flex items-center justify-between px-5 py-3 rounded-full backdrop-blur-xl bg-background/80 border border-border/50 shadow-sm">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden">
        ...
        <div className="hidden md:block container mx-auto max-w-5xl text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-sm font-medium text-primary mb-8 animate-fade-in">
            ...
            AttendX 2.6.2 is live at IIITU
          </div>
