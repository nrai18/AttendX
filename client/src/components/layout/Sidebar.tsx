...
const navItems = [
  ...
  { label: "Predictive", path: "/predictive", icon: Sparkles },
...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      <aside className="hidden md:flex flex-col w-64 h-screen bg-card border-r border-border p-4 sticky top-0 transition-colors z-30">
        {/* Brand Logo */}
