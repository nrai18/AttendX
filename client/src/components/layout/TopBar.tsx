...
export const TopBar: React.FC<TopBarProps> = ({
  ...
  return (
    <>
      <header className="sticky top-0 z-20 bg-background/80 backdrop-blur-md border-b border-border px-4 py-3 pt-[calc(0.75rem+env(safe-area-inset-top))] transition-colors">
